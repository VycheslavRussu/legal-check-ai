...
class UseCase:
    ...
    def __init__(self, folder_id, api_key):
        ...
        self.yandex_gpt = YandexGPT(self.__folder_id, self.__api_key)
        pass

    # Задаем начальный контекст, передаем сюда промт и первое сообщение пользователя
    setup_messages = [
        {
            "role": "system",
    ...
    def setup_context(self):
        """
        Задаем дефолтный контекст для модели. Вызывали метод set_default_context
        """
...
test_use_case = UseCase(ENV, API_KEY)

# Задали промпт и дефолтный контекст
test_use_case.setup_context()
